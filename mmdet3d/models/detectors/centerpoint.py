...
@DETECTORS.register_module()
class CenterPoint_lss(CenterPoint):
    def __init__(self, transformer, **kwargs):
        super(CenterPoint_lss,
              self).__init__(**kwargs)
        self.transformer = builder.build_neck(transformer)

    def extract_feats_image_encoder(self, img, img_metas):
        imgs = img
    ...
    def extract_img_feat(self, img, img_metas):
        ...
        x = self.extract_feats_image_encoder(img[0], img_metas)
